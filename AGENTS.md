...
- Utiliser le skill `ux-ui` pour une demande d’interface du portail. Le paquet ne contient pas nécessairement le code de l’interface : vérifier le dépôt amont avant de modifier des fichiers de packaging.
